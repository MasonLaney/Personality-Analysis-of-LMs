...
from transformers import PreTrainedModel, BertTokenizer, AutoModelForSequenceClassification, TrainingArguments, Trainer, EvalPrediction
...
class EnsembleForSeqClass(PreTrainedModel):
