...
encoded_dataset_train = dataset['test'].map(prepare_dataset, remove_columns=dataset['train'].column_names, load_from_cache_file=True, writer_batch_size=2000)
encoded_dataset_train.set_format('torch')
encoded_dataset_train.save_to_disk('FIV2_video_test')
exit()
'''
...
trainer = CustomTrainer(
    ...
    eval_dataset=encoded_dataset['validate'].select(range(10)),
