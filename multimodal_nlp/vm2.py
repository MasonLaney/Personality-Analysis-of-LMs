...
encoded_dataset_train = dataset['train'].select(range(2000,4000)).map(prepare_dataset, remove_columns=dataset['train'].column_names, load_from_cache_file=True, writer_batch_size=2000)
