...
encoded_dataset_validate = dataset['validate'].map(prepare_dataset, remove_columns=dataset['train'].column_names)
encoded_dataset_validate.set_format('torch')
encoded_dataset_validate.save_to_disk('FIV2_video_validate')
exit()
