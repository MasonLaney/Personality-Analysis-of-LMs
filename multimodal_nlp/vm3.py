...
encoded_dataset_train = dataset['train'].select(range(4000,5961)).map(prepare_dataset, remove_columns=dataset['train'].column_names, load_from_cache_file=True, writer_batch_size=2000)
encoded_dataset_train.set_format('torch')
encoded_dataset_train.save_to_disk('FIV2_video_train3')
exit()