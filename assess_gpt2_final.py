...
def assess_models(base_model_name, model_names, seeds=SEEDS):
    ...
    for model_name in model_names:
        ...
        for seed in seeds:
            ...
            models[str(seed)] = AutoModelForCausalLM.from_pretrained(f'{DATA_DIR}final_models/gpt2/{model_name}_{seed}')
        ...
        with open(f'{DATA_DIR}final_assessment_results/gpt2/{model_name}.csv', 'w', newline='') as f:
